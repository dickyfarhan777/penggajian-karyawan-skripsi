...
<aside class="app-sidebar">
      <ul class="app-menu">
            ...
            <?php if (isset($_SESSION['login']['role_akses'])) { ?>
                  <li><a class="app-menu__item" href="index.php?data_admin"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Data Admin</span></a>
                  </li>
                  ...
                  <li><a class="app-menu__item" href="index.php?data_pegawai"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Data Karyawan</span></a>
                  </li>
                  <li><a class="app-menu__item" href="index.php?data_complain"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Data Complain Karyawan</span></a>
                  </li>
            <?php } ?>
